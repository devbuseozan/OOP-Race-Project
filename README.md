...
Unit Tests (YarismaTest.cs): A test suite used to verify the functionality of the classes and ensure the race logic operates as expected.
...
You can execute the tests using YarismaTest.cs to verify the implementation.

Developed as part of the OOP course curriculum.
